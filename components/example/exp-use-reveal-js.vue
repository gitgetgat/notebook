...
<style lang="less">
// 这里为了不影响全局样式，将以下两个文件的css代码copy到这里并用 reveal-container 类名包裹，将css变量提到外面定义，"--r-controls-spacing: 12px;" 这个变量没定义在reveal.js中，所以手动添加一个
...
:root {
  ...
  --r-controls-spacing: 12px; // 这个变量没定义在reveal.js中
}
.reveal-container {
  .reveal h2 {
    border-top: none;

...
const currentPage = sidebar.value[0].items.find(e => page.value.filePath.indexOf(e.meta.fileName) > -1)
/**
...
function tagToSidebar(tag) {
  const ele = sidebar.value.find(i => i.text.toLowerCase() === tag.toLowerCase());

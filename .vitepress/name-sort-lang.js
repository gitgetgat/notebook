...
const VUE3_COMPILATION_PRINCIPLE_REVEALED_LABELS = [
  ...
  {
    zh: `原来 vue3 中 template 使用 ref 无需 .value 是因为这个`,
    en: `it-turns-out-that-in-vue3-template-uses-ref-without-.value-because-of-this`,
    parentDir: ["Vue3-Compilation-Principle-Revealed"],
    meta: {
      star: 5,
      state: "已完成",
  ...
  {
    zh: `template 可以直接使用 setup 语法糖中的变量原来是因为这个`,
    en: `the-template-can-directly-use-the-variables-in-the-setup-syntax-sugar-because-of-this`,
    parentDir: ["Vue3-Compilation-Principle-Revealed"],
    meta: {
      star: 5,
      state: "已完成",
